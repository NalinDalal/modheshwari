...
async function main() {
  ...
  console.log(" ─────────────────────────────────────────────");
  console.log(" 👑 Community Head:  vikram@demo.com");
  console.log(" 👑 Subhead:         sunita@demo.com");
  console.log(" 🏘️  Gotra Head:      ramesh@demo.com");
  console.log(" 🏘️  Gotra Head:      anand@demo.com");
  console.log(" 🏠 Family Head:     rajesh@demo.com  (Mehta Family)");
  console.log(" 🏠 Family Head:     priya@demo.com   (Shah Family)");
  console.log(" 🏠 Family Head:     amit@demo.com    (Patel Family)");
  console.log(" 🏠 Family Head:     deepak@demo.com  (Verma Family)");
  console.log(" 👤 Member:          neha@demo.com    (Mehta)");
  console.log(" 👤 Member:          rohan@demo.com   (Mehta)");
  console.log(" 👤 Member:          sanjay@demo.com  (Shah)");
  console.log(" 👤 Member:          kavita@demo.com  (Patel)");
  console.log(" 👤 Member:          arjun@demo.com   (Verma)");
  console.log(" 👤 Member:          megha@demo.com   (Invited)");
  console.log(" ─────────────────────────────────────────────");
  console.log(" 📊 Summary:");
  console.log(`    ${allUsers.length} users (4 admins, 4 family heads, 6 members)`);
  console.log("    4 families (Mehta, Shah, Patel, Verma)");
  console.log("    3 events (1 pending, 1 approved, 1 rejected)");
  console.log("    4 resources (hall, projector, sound system, bus)");
  console.log("    3 resource requests (approved, pending, rejected)");
  console.log("    2 conversations with messages");
  console.log("    7 notifications with delivery tracking");
}
